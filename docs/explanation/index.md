...
Tunapi is stateless by default, but can provide “continuation” in multiple ways:
...
Tunapi uses entrypoint-based plugins with lazy discovery so broken plugins don’t brick the CLI.
