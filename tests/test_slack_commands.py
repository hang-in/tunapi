...
class TestHelpDispatcherConsistency:
    ...
    def test_no_rt_in_help(self):
        """!rt should not appear in help (not implemented for Slack)."""
        assert "!rt" not in _get_help_text()

    def test_no_file_in_help(self):
        """!file should not appear in help (not implemented for Slack)."""
        assert "!file" not in _get_help_text()
