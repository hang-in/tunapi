...
Tunapi runs coding agents on your computer and bridges them to Telegram. Send tasks from anywhere, watch progress stream live, pick up when back at the terminal. Scale from quick one-offs to multi-project workflows with topics and parallel worktrees.
...
You can change workflows later by editing `~/.tunapi/tunapi.toml`.

## Tutorials

Step-by-step guides for new users:

1. [Install & onboard](tutorials/install.md) — set up Tunapi and your bot
