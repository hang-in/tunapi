...
class TelegramBackend(TransportBackend):
    ...
    def build_and_run(
        ...
        *,
        ...
        self._pending_default_engine_override = default_engine_override
    ...
    async def async_run(self) -> None:
        ...
        await run_main_loop(
            self._pending_cfg,
            watch_config=self._pending_runtime.watch_config,
            default_engine_override=self._pending_default_engine_override,
            transport_id=self.id,
            transport_config=self._pending_settings,
        )
