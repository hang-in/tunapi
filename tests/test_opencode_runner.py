...
from tunapi.model import ActionEvent, CompletedEvent, ResumeToken, StartedEvent
from tunapi.runners.opencode import (
    OpenCodeRunner,
    OpenCodeStreamState,
    ENGINE,
    translate_opencode_event,
)
from tunapi.schemas import opencode as opencode_schema
...
def test_translate_tool_use_read_title_wraps_path() -> None:
    ...
    state.session_id = "ses_test123"
    state.emitted_started = True
    path = Path.cwd() / "src" / "tunapi" / "runners" / "opencode.py"
        ...
        _decode_event(
            {
                ...
                "part": {
                    ...
                    "state": {
                        ...
                        "title": "src/tunapi/runners/opencode.py",
                    },
                },
            }
        ),
    ...
    assert action_event.action.title == "`src/tunapi/runners/opencode.py`"
